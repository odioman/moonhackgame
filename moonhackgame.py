...
items = [
    ...
    "J: An android"
    "K: An extra pair of space boots"
    "L: A mombot"
    "M: George Jettson"
]
...
if "I" not in user_list:
    print("You will not make it to the moon base wihtout food. You will need energy to drive the lunar rover")

    if "A" in user_list and "E" in user_list and "F" in user_list and "I" in user_list:
        print("Hooray! You picked the correct 4 items! You will make it to the moon base!")
    else:
        print("You did not pick the correct 4 items 4 survival. You will not make it. Goodbye.")